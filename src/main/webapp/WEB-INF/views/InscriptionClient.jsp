...
<body>
   ...
   <form:form action="saveClient" method="POST" ModelAttribute="newClient" >
     <div class="row contact_left_grid">
       <div class="col-md-6 con-left">
			<div class="form-group">
				<label class="my-2" style=" font: 1rem 'Cooper Black', sans-serif; text-align: justify; color: #D8BFD8 ;">Nom</label>
				 <input type="text" class="form-control"  name="nom" placeholder="Entrez votre Prenom"  style=" text-align: justify; width:500px;" />
			
			</div>
			
			<div class="form-group">
				<label style=" font: 1rem 'Cooper Black', sans-serif; text-align: justify; color: #D8BFD8 ;">Prenom</label>
				<input class="form-control" type="text" name="prenom" placeholder="Entrez votre Prenom" required="" style=" text-align: justify; width:500px;" />
			</div>

			<div class="form-group">
				<label class="my-2" style=" font: 1rem 'Cooper Black', sans-serif; text-align: justify; color: #D8BFD8 ;">Mot de Passe</label>
				<input class="form-control" type="password" name="password" placeholder="Entrez votre Mot de passe" required="" style=" text-align: justify; width:500px;" />
			</div>
          ...
          <div class="col-md-6 con-right">
			...
			<div class="form-group">
				<label class="my-2" style=" font: 1rem 'Cooper Black', sans-serif; text-align: justify; color: #D8BFD8 ;">Email</label>
				<input class="form-control" type="email" name="email" placeholder="Entrez votre Email" required="" style=" text-align: justify; width:500px;" />
			</div>

			<div class="form-group">
				<label class="my-2" style=" font: 1rem 'Cooper Black', sans-serif; text-align: justify; color: #D8BFD8 ;">Pays</label>
				<input class="form-control" type="text" name="pays" placeholder="Entrez votre Pays" required="" style=" text-align: justify; width:500px;" />
			</div>

			<div class="form-group">
				<label style=" font: 1rem 'Cooper Black', sans-serif; text-align: justify; color: #D8BFD8 ;">Adresse</label>
				<input class="form-control" type="text" name="adresse" placeholder="Entrez votre adresse" required="" style=" text-align: justify; width:500px;" />
			</div>

			<div class="form-group">
				<label class="my-2" style=" font: 1rem 'Cooper Black', sans-serif; text-align: justify; color: #D8BFD8 ;">Numero de Telephone</label>
				<input class="form-control" type="text" name="tel" placeholder="Entrez votre numero de telephone" required="" style=" text-align: justify; width:500px;" />
			</div>

			<input class="form-control" name="inscrir" type="submit" value="Inscrire" style="background-color: #D8BFD8 ; width:500px;" />
			</div>
			</div>
			<br><br> <br>
</div>
	   </form:form>
	<a href="${login }" class="my-2" style=" font: 1rem 'Cooper Black', sans-serif; text-align: justify; color: #D8BFD8 ;">Vous avez d&ecutej&agrave un compte ? SE CONNECTER</a>
