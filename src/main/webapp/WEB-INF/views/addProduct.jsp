 ...
 <script type="text/javascript">
        ...
        $(document).ready(function () {
			...
			<div class="women_main">
				...
				<div class="catalog">
					...
					<div class="graph">
			              <form action="saveProduct"  method="post"  >
								<section id="section-1" class="content-current">
									<div class="fo-top">
										<div class="form-group">
											<label for="focusedinput" class="col-sm-2 control-label">Nom Produit</label>
											<div class="col-sm-8 ctl">
												<input type="text" name="nomProduit" class="form-control1" id="focusedinput" placeholder="nomProduit">
											</div>
			                    ...
			                    <div class="fo-top">
			                      <div class="form-group">
			                        <label for="focusedinput" class="col-sm-2 control-label">Categorie</label>
			                        <div class="col-sm-8 ctl">
			                          <select name="nomCategorie" id="field-2" required="true" class="form-control">
			                        <c:forEach var="cat" items="${listCategorie}" varStatus="status">
			                        ...
			                        <div class="clearfix"></div>
										...
										<div class="fo-top">
											<div class="form-group">
												<label for="focusedinput" class="col-sm-2 control-label">Prix(DH)</label>
												<div class="col-sm-8 ctl">
													<input type="text" name="prix" class="form-control1" id="focusedinput" placeholder="">
												</div>
												<div class="col-sm-2 hp">
													<p class="help-block">(Obligatoire)</p>
												</div>
										...
										<div class="fo-top">
											<div class="form-group">
												...
												<div class="col-sm-8 ctl">
													<input type="text" name="description" class="form-control1" id="focusedinput" placeholder="ce produit ...">
												</div>
												<div class="col-sm-2 hp">
													<p class="help-block">(Obligatoire)</p>
												</div>
										...
										<div class="fo-top">
											<div class="form-group">
												...
												<div class="col-sm-8 ctl">
													<input type="file" name="photo" class="form-control1" id="focusedinput">
												</div>
												<div class="col-sm-2 hp">
													<p class="help-block">(Obligatoire)</p>
												</div>
               ...
               <button type="submit"  style:" Background-color= black">Ajouter</button>
									</section>
                  </form>
								...
								<script src="${pageContext.request.contextPath}/resources/adminjs/cbpFWTabs.js"></script>
									<script>
