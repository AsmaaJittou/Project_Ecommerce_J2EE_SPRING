            ...
            <!-- header-starts -->
                ...
                <div class="header_bg">
                      ...
                      <div class="header">
                        <div class="head-t">
                          <div class="logo">
                            <a href="index.html"><img src="images/logo.png" class="img-responsive" alt="" Style="margin-left: 50% ;"> </a>
                          </div>
                            <!-- start header_right -->
        ...
        <table class="table table-striped table-bordered" style=" margin-right: 100%; width:1000px;  top:1000px; left:2700px; background-color: white ; ">
        <thead>
        <tr>
           <th style="width: 100px;   color: #D8BFD8;">id </th>
           <th style="width: 100px;   color: #D8BFD8;">nom </th>
           <th style="width: 100px;   color: #D8BFD8;">prenom </th>
           <th style="width: 100px;   color: #D8BFD8;">email </th>
           <th style="width: 100px;   color: #D8BFD8;">adresse </th>
        </tr>
        
<%-- 
                      <tr>
            <th style="width: 100px; height : 100px; color: #282C34;"><%=client.getId() %> </th>
            <th style="width: 100px; color: #282C34;"><%= client.getNom() %></th>
            <th style="width: 100px; color: #282C34;"><%=client.getPrenom() %> </th>
            <th style="width: 100px; color: #282C34;"><%=client.getEmail() %> </th>
            <th style="width: 100px; color: #282C34;"><%=client.getAdresse() %> </th>
        ...
        <div class="sidebar-menu">
          <header class="logo1">
            ...
            <div class="menu">
              ...
              <li id="menu-academico-avaliacoes" ><a href="listeProduit.jsp">Liste des produits</a></li>
              <li id="menu-academico-boletim" ><a href="addProduct.jsp">Ajouter un produits</a></li>
              <li id="menu-academico-avaliacoes" ><a href="listeCategorie.jsp">Liste des catalogues</a></li>
              </ul>
              </li>
              ...
              <li ><a href="calendrier.jsp"><i class="fa fa-table"></i> <span>Calendrier</span> </a></li>
              </ul>
            </div>
                </div>
                <div class="clearfix"></div>
