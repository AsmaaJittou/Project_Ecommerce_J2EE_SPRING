...
<body>
					...
					<div class="row">
							<div class="col-lg-4 single-right-left ">
										...
										<div class="flexslider1">
											...
											<ul class="slides">
												<li data-thumb="images/d2.jpg">
													<div class="thumb-image"> <img src="${pageContext.request.contextPath}/resources/images/${article.photo }" data-imagezoom="true" class="img-fluid" alt=" "> </div>
												</li>
								...
								<div class="col-lg-8 single-right-left simpleCart_shelfItem">
									<h3>${article.nomProduit }</h3>
									<p><span class="item_price">${produit.prix }</span>
									</p>
											...
											<div class="product-googles-info slide-img googles">
												<div class="men-pro-item">
													<div class="men-thumb-item">
														<img src="${pageContext.request.contextPath}/resources/images/s5.jpg" class="img-fluid" alt="">
	...
	<footer class="py-lg-5 py-3">
		...
		<script src="${pageContext.request.contextPath}/resources/js/easy-responsive-tabs.js"></script>
		<script>
			$(document).ready(function () {
