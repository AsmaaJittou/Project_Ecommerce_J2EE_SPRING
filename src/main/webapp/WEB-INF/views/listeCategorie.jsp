    ...
    <table class="table table-striped table-bordered" style=" width:1000px; top:200px; left:270px; background-color: white ; ">
    <thead>
    <tr>
       <th style="width: 60px;   color: #D8BFD8;">nomProduit </th>
       <th style="width: 60px;   color: #D8BFD8;">Action </th>
      
    </tr>
  <%-- 
                  <tr>
        <th style="width: 60px; color: #282C34;"><%= pelem %> </th>
        <th align="center"><a href="../DeleteCategorieServlet?categorie=<%= pelem%>"><button type="button">Supprimer</button></a></th>
    ...
    <form action="addCategorie"  method="post" >
              										...
              										<div class="fo-top">
              											<div class="form-group">
              												<label for="focusedinput" class="col-sm-2 control-label">Nom Categorie</label>
              												<div class="col-sm-8 ctl">
              													<input type="text" name="nomCategorie"  class="form-control1" id="focusedinput" placeholder="Ajouter une categorie">
              												</div>
