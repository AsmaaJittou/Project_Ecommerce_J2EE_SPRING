	...
	<section class="banner-bottom-wthreelayouts py-lg-5 py-3">
		<div class="container-fluid">
			...
			<div class="inner-sec-shop px-lg-4 px-3">
				<div class="about-content py-lg-5 py-3">
					<div class="row">
						...
						<div class="col-lg-6 p-0">
							<img src="${pageContext.request.contextPath}/resources/images/sac.jpg" alt="Goggles" class="img-fluid">
						</div>
							<div class="col-lg-6 about-info">
							<h3 class="tittle-w3layouts text-left mb-lg-5 mb-3">A PROPOS</h3>
							<p style="color:black; font: 1rem 'Book Antiqua', sans-serif;  text-align: justify;">MOROCCO BEING <br>
							Cr&eacute&eacute en mai 2019, MOROCCO BEING est le site e-commerce N 1 au Maroc dont l’objectif et la vision sont de fournir le plus large assortiment au meilleur prix pour tous les Marocains et les &eacutetrang&egraveres.<br>
							
							MOROCCO BEING propose une qualit&eacute de services adapt&eacutes au e-commerce en Monde : livraison dans tout le royaume, m&eacutethodes de paiement flexibles (paiement en cash &agrave  la livraison, par carte bancaire) et retours gratuits sous un d&eacutelai de 7 jours.<br>
						 </p>
				...
				<h3 class="tittle-w3layouts text-center my-lg-4 my-4">Parteneurs</h3>
				<div class="partners-info">
					<div class="row mt-lg-5 mt-3">

					 <div class="img-prtnir team-main-gd">
